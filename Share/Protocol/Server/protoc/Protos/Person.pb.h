...
#ifndef PROTOBUF_Protos_2fPerson_2eproto__INCLUDED
#define PROTOBUF_Protos_2fPerson_2eproto__INCLUDED
...
void  protobuf_AddDesc_Protos_2fPerson_2eproto();
void protobuf_AssignDesc_Protos_2fPerson_2eproto();
void protobuf_ShutdownFile_Protos_2fPerson_2eproto();
...
class Person_PhoneNumber : public ::google::protobuf::Message {
 public:
  ...
  // optional .Protocol.Person.PhoneType type = 2 [default = HOME];
  inline bool has_type() const;
  inline void clear_type();
  static const int kTypeFieldNumber = 2;
  inline ::Protocol::Person_PhoneType type() const;
  inline void set_type(::Protocol::Person_PhoneType value);
 ...
 private:
  ...
  friend void  protobuf_AddDesc_Protos_2fPerson_2eproto();
  friend void protobuf_AssignDesc_Protos_2fPerson_2eproto();
  friend void protobuf_ShutdownFile_Protos_2fPerson_2eproto();
...
class Person : public ::google::protobuf::Message {
 public:
  ...
  // repeated .Protocol.Person.PhoneNumber phone = 4;
  inline int phone_size() const;
  inline void clear_phone();
  static const int kPhoneFieldNumber = 4;
  inline const ::Protocol::Person_PhoneNumber& phone(int index) const;
  inline ::Protocol::Person_PhoneNumber* mutable_phone(int index);
  inline ::Protocol::Person_PhoneNumber* add_phone();
 ...
 private:
  ...
  ::std::string* name_;
  ::std::string* email_;
  ::google::protobuf::RepeatedPtrField< ::Protocol::Person_PhoneNumber > phone_;
...
inline void Person_PhoneNumber::set_type(::Protocol::Person_PhoneType value) {
  assert(::Protocol::Person_PhoneType_IsValid(value));
  set_has_type();
  type_ = value;
}
...
inline const ::Protocol::Person_PhoneNumber& Person::phone(int index) const {
  return phone_.Get(index);
}
inline ::Protocol::Person_PhoneNumber* Person::mutable_phone(int index) {
  return phone_.Mutable(index);
}
inline ::Protocol::Person_PhoneNumber* Person::add_phone() {
  return phone_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::Protocol::Person_PhoneNumber >&
Person::phone() const {
...
#endif  // PROTOBUF_Protos_2fPerson_2eproto__INCLUDED
