...
namespace ProtoBuf.CodeGenerator
{
    public static class InputFileLoader
    {
        ...
        {
#if UNITY_EDITOR_OSX
			return Path.Combine (UnityEngine.Application.dataPath, "Editor/ProtoGen/mac/protoc");
#else
			return Path.Combine (UnityEngine.Application.dataPath, "Editor/ProtoGen/protoc.exe");
#endif
			/*
