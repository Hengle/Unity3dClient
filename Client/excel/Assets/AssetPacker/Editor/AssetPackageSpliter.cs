...
public class AssetPackageSpliter : EditorWindow
{
    ...
    [MenuItem("AssetPacker/Build Split Package")]
    static void Init()
    {
    ...
    static protected void _GenerateBasePacakge()
    {
        ...
        if (null != monstertbl)
        {
            for (int i = monstertbl.Xls_data_index; i < monstertbl.RowCount; ++i)
            {
        ...
        {
            for (int i = citySceneTable.Xls_data_index; i < citySceneTable.RowCount; ++i)
            {
        ...
        {
            for (int i = destrucTable.Xls_data_index; i < destrucTable.RowCount; ++i)
            {
        ...
        if (null != jobtbl)
        {
            for (int i = jobtbl.Xls_data_index; i < jobtbl.RowCount; ++i)
            {
