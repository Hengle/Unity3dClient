...
public class AssetPacker : EditorWindow
{
    ...
    static public AssetPackCommand[] m_PackCommands = new AssetPackCommand[]
    {
        ...
        //new AssetPackCommand(EAssetType.Scene   ,new string[] { "Assets/Resources/Scene/Chapter1_Aierwenfangxian" }       ,null                                                                                                                                                                         , PackPolicyScene       , 0),
        //new AssetPackCommand(EAssetType.Scene   ,new string[] { "Assets/Resources/Scene/Chapter2_Gelanzhisen" }           ,null                                                                                                                                                                         , PackPolicyScene       , 0),
        //new AssetPackCommand(EAssetType.Scene   ,new string[] { "Assets/Resources/Scene/Chapter3_Tiankongzhicheng" }      ,null                                                                                                                                                                         , PackPolicyScene       , 0),
        //new AssetPackCommand(EAssetType.Scene   ,new string[] { "Assets/Resources/Scene/Chapter4_Wannianxueshan" }        ,null                                                                                                                                                                         , PackPolicyScene       , 0),
        //new AssetPackCommand(EAssetType.Scene   ,new string[] { "Assets/Resources/Scene/Chapter5" }                       ,null                                                                                                                                                                         , PackPolicyScene       , 0),
		//new AssetPackCommand(EAssetType.Scene   ,new string[] { "Assets/Resources/Scene/Chapter6" }                       ,null                                                                                                                                                                         , PackPolicyScene       , 0),
        //new AssetPackCommand(EAssetType.Scene   ,new string[] { "Assets/Resources/Scene/Chapter6_Other" }                 ,null                                                                                                                                                                         , PackPolicyScene       , 0),
		//new AssetPackCommand(EAssetType.Scene   ,new string[] { "Assets/Resources/Scene/Chapter7" }                       ,null                                                                                                                                                                         , PackPolicyScene       , 0),
        //new AssetPackCommand(EAssetType.Scene   ,new string[] { "Assets/Resources/Scene/Chapter7_Other" }                 ,null                                                                                                                                                                         , PackPolicyScene       , 0),
        //new AssetPackCommand(EAssetType.Scene   ,new string[] { "Assets/Resources/Scene/Start" }                          ,null                                                                                                                                                                         , PackPolicyScene       , 0),
        ...
        //new AssetPackCommand(EAssetType.UI      ,new string[] { "Assets/Resources/UI"}                                    ,new string[] { "Assets/Resources/UI/Font" , "Assets/Resources/UI/Image",}                                                                                                         , PackPolicyUI              , 2),
        //new AssetPackCommand(EAssetType.UI      ,new string[] { "Assets/Resources/UI/Font" }                              ,null                                                                                                                                                                             , PackPolicyUIFont          , 0),
        //new AssetPackCommand(EAssetType.UI      ,new string[] { "Assets/Resources/UI/Animation/Anim_chengHao_Formal" }    ,null                                                                                                                                                                         , PackPolicyUITitle         , 1),
        ...
        //new AssetPackCommand(EAssetType.UI      ,new string[] { "Assets/Resources/UIFlatten"}                             ,new string[] { "Assets/Resources/UIFlatten/Font" }                                                                                                                          , PackPolicyUI              , 2),
        ...
        //new AssetPackCommand(EAssetType.UI      ,new string[] { "Assets/Resources/UI/Image/BG" }                            ,null                                                                                                                                                                         , PackPolicyUIImage       , 1),
    ...
    [MenuItem("AssetPacker/Pack Assets")]
    static void Init()
    {
    ...
    static public void PackPolicyShader(EAssetType assetType, string[] assetPath, string[] exclusivePath, int packLv, List<AssetPackageDesc> descList)
    {
        ...
        for (int i = 0; i < assetPath.Length; ++i)
        {
            _PackAssetByRootDirectory(assetType,assetPath[i], "shader", descList, new string[] { ".shader", ".png", ".asset", ".json" }, new string[] { ".cs", ".dll" }, exclusivePath, (uint)DAssetPackageFlag.None, true);
        }
    }
    ...
    static public void PackPolicyScene(EAssetType assetType, string[] assetPath, string[] exclusivePath, int packLv, List<AssetPackageDesc> descList)
    {
        ...
        for (int i = 0; i < assetPath.Length; ++i)
        {
            _PackAssetByDirectoryLevel(assetType, assetPath[i], "scene", descList, new string[] { ".prefab", ".asset" }, new string[] { ".cs", ".dll" }, exclusivePath, (uint)DAssetPackageFlag.None, true, packLv, 0);
        }
    }
    ...
    //[MenuItem("AssetPacker/导出资源包依赖信息")]
