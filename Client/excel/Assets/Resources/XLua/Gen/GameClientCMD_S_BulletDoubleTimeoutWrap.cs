...
namespace XLua.CSObjectWrap
{
    ...
    public class GameClientCMD_S_BulletDoubleTimeoutWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(GameClient.CMD_S_BulletDoubleTimeout);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(GameClient.CMD_S_BulletDoubleTimeout));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to GameClient.CMD_S_BulletDoubleTimeout constructor!");
        ...
        static int _g_get_chair_id(RealStatePtr L)
        {
		    try {
                ...
                GameClient.CMD_S_BulletDoubleTimeout __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
