...
namespace XLua.CSObjectWrap
{
    ...
    public class GameClientCMD_S_CatchFishGroupWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(GameClient.CMD_S_CatchFishGroup);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(GameClient.CMD_S_CatchFishGroup));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to GameClient.CMD_S_CatchFishGroup constructor!");
        ...
        static int _g_get_tick_count(RealStatePtr L)
        {
		    try {
                ...
                GameClient.CMD_S_CatchFishGroup __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                LuaAPI.lua_pushint64(L, __cl_gen_to_be_invoked.tick_count);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_tick_count(RealStatePtr L)
        {
		    try {
                ...
                GameClient.CMD_S_CatchFishGroup __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                __cl_gen_to_be_invoked.tick_count = LuaAPI.lua_toint64(L, 2);
