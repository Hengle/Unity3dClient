...
namespace XLua.CSObjectWrap
{
    ...
    public class GameClientCMD_S_SceneFishWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(GameClient.CMD_S_SceneFish);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "elapsed", _s_set_elapsed);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(GameClient.CMD_S_SceneFish));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to GameClient.CMD_S_SceneFish constructor!");
        ...
        static int _g_get_fish_id(RealStatePtr L)
        {
		    try {
                ...
                GameClient.CMD_S_SceneFish __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_elapsed(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                GameClient.CMD_S_SceneFish __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                __cl_gen_to_be_invoked.elapsed = (float)LuaAPI.lua_tonumber(L, 2);
