...
void protobuf_AssignDesc_MsgHead_2eproto() {
  ...
  static const int MsgHead_offsets_[3] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MsgHead, size_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MsgHead, id_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MsgHead, subid_),
  };
  MsgHead_reflection_ =
...
void protobuf_AddDesc_MsgHead_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\rMsgHead.proto\022\010Protocol\"C\n\007MsgHead\022\014\n\004"
    "size\030\001 \002(\021\022\033\n\002id\030\002 \002(\0162\017.Protocol.MsgID\022"
    "\r\n\005subId\030\003 \002(\021*\026\n\005MsgID\022\r\n\007MID_LOG\020\336\230\001", 118);
...
#ifndef _MSC_VER
const int MsgHead::kSizeFieldNumber;
const int MsgHead::kIdFieldNumber;
const int MsgHead::kSubIdFieldNumber;
#endif  // !_MSC_VER
...
void MsgHead::SerializeWithCachedSizes(
  ...
  // required sint32 size = 1;
  if (has_size()) {
    ::google::protobuf::internal::WireFormatLite::WriteSInt32(1, this->size(), output);
  }
  ...
  // required sint32 subId = 3;
  if (has_subid()) {
    ::google::protobuf::internal::WireFormatLite::WriteSInt32(3, this->subid(), output);
  }
...
::google::protobuf::uint8* MsgHead::SerializeWithCachedSizesToArray(
  ...
  // required sint32 size = 1;
  if (has_size()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteSInt32ToArray(1, this->size(), target);
  }
  ...
  // required sint32 subId = 3;
  if (has_subid()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteSInt32ToArray(3, this->subid(), target);
  }
