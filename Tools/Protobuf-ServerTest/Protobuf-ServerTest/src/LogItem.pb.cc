...
void protobuf_AssignDesc_LogItem_2eproto() {
  ...
  static const int LogItem_offsets_[5] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(LogItem, id_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(LogItem, subid_),
...
void protobuf_AddDesc_LogItem_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\"\324\001\n\007LogItem\022$\n\002id\030\001 \001(\0162\017.Protocol.MsgI"
    "D:\007MID_LOG\022\r\n\005subId\030\002 \002(\021\022\r\n\005logId\030\003 \002(\021"
    "\022\020\n\010logValue\030\004 \002(\t\022+\n\010eLogType\030\005 \002(\0162\031.P"
    "rotocol.LogItem.LogType\"F\n\007LogType\022\r\n\tLT"
    "_NORMAL\020\001\022\016\n\nLT_WARNING\020\002\022\014\n\010LT_ERROR\020\004\022"
    "\016\n\nLT_PROCESS\020\010", 255);
...
#endif  // _MSC_VER
#ifndef _MSC_VER
const int LogItem::kIdFieldNumber;
const int LogItem::kSubIdFieldNumber;
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (::Protocol::MsgID_IsValid(value)) {
            set_id(static_cast< ::Protocol::MsgID >(value));
          } else {
        ...
        if (input->ExpectTag(16)) goto parse_subId;
        break;
      }
      ...
      case 3: {
        ...
        if (input->ExpectTag(34)) goto parse_logValue;
        break;
      }
      ...
      case 4: {
        ...
        if (input->ExpectTag(40)) goto parse_eLogType;
        break;
      }
...
void LogItem::SerializeWithCachedSizes(
  ...
  // required sint32 subId = 2;
  if (has_subid()) {
    ::google::protobuf::internal::WireFormatLite::WriteSInt32(2, this->subid(), output);
  }

  // required sint32 logId = 3;
  if (has_logid()) {
    ::google::protobuf::internal::WireFormatLite::WriteSInt32(3, this->logid(), output);
  }
  ...
  if (has_logvalue()) {
    ...
    ::google::protobuf::internal::WireFormatLite::WriteString(
      4, this->logvalue(), output);
  }

  // required .Protocol.LogItem.LogType eLogType = 5;
  if (has_elogtype()) {
    ::google::protobuf::internal::WireFormatLite::WriteEnum(
      5, this->elogtype(), output);
  }
...
::google::protobuf::uint8* LogItem::SerializeWithCachedSizesToArray(
  ...
  // required sint32 subId = 2;
  if (has_subid()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteSInt32ToArray(2, this->subid(), target);
  }

  // required sint32 logId = 3;
  if (has_logid()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteSInt32ToArray(3, this->logid(), target);
  }
  ...
  if (has_logvalue()) {
    ...
    target =
      ::google::protobuf::internal::WireFormatLite::WriteStringToArray(
        4, this->logvalue(), target);
  }

  // required .Protocol.LogItem.LogType eLogType = 5;
  if (has_elogtype()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteEnumToArray(
      5, this->elogtype(), target);
  }
